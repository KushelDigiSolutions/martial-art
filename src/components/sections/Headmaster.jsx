...
export default function Headmaster() {
  return (
    <section className="bg-brand-red text-white py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        
        {/* Left Text Box */}
        <div className="md:col-span-5 relative z-20">
          <p className="text-white font-bold tracking-[0.2em] text-sm uppercase mb-4">Meet The Head</p>
          <div className="border-l-4 border-t-4 border-white pt-8 pl-8 relative">
            {/* The name is huge and overlaps */}
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter leading-none -ml-4 bg-brand-red inline-block pr-4">
              DAVID<br/>JONES
            </h2>
          </div>
        </div>
        ...
        <div className="md:col-span-4 space-y-6 relative z-20 md:pl-12">
          <p className="text-lg leading-relaxed font-light italic">
            "Martial arts is not about fighting; it's about building character. We train our bodies and minds to be strong, focused, and respectful. Our goal is to empower our students to overcome challenges both on and off the mat."
          </p>
          {/* Faux Signature */}
