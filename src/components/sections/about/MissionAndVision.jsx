...
export default function MissionAndVision() {
  return (
    <section
      className="relative bg-brand-dark py-12 sm:py-16 lg:py-20 text-white"
      style={{
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-8 relative z-10 space-y-8 md:space-y-14">

        {/* OUR VISION */}
        <div>
          <div className="w-full h-px bg-brand-gray mb-6 relative">
            <div className="absolute top-0 left-0 h-[2px] w-32 bg-brand-red"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start">
            <div className="md:col-span-4">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tighter font-display uppercase">OUR VISION</h2>
            </div>
            <div className="md:col-span-8">
              <p className="text-gray-300 font-sans font-light leading-relaxed text-base sm:text-lg md:text-xl">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start">
            <div className="md:col-span-4">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tighter font-display uppercase">OUR MISSION</h2>
            </div>
